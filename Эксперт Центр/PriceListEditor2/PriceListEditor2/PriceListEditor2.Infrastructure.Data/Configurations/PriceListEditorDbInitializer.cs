...
namespace PriceListEditor2.Infrastructure.Data.Configurations
{
    public class PriceListEditorDbInitializer : DropCreateDatabaseAlways<PriceListEditorContext>
    {
        ...
        {
            IList<PriceList> defaultPriceLists = new List<PriceList>()
            {
            ...
            dbContext.PriceLists.AddRange(defaultPriceLists);

            IList<PriceListColumn> defaultPriceListColumns = new List<PriceListColumn>()
            {
            ...
            dbContext.PriceListColumns.AddRange(defaultPriceListColumns);

            IList<PriceListProduct> defaultPriceListProducts = new List<PriceListProduct>()
            {
            ...
            dbContext.PriceListProducts.AddRange(defaultPriceListProducts);

            IList<PriceListCell> defaultPriceListCells = new List<PriceListCell>()
            {
            ...
            dbContext.PriceListCells.AddRange(defaultPriceListCells);
